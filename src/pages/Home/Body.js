  ...
  return (    
    <main>
      <div id="work" className="section grid-items">
          ...
          <a className="grid-item jpmc" href="https://www.jpmorganchase.com/">
              <div className="grid-item-bg" style={{backgroundImage: `url(${banking})`}}></div>
              <h1 className="grid-item-header">
              J.P. Morgan
              </h1>
          ...
          <a className="grid-item grid-item-last sbisd" href="https://www.springbranchisd.com/">
              <h1 className="grid-item-header">
              Spring Branch ISD
              </h1>
              <div className="case-item-content">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 370 370" className="case-item-icon icon-sbisd">
                      <path id="sbisd-path-0" d="" stroke="none" fill="#fff" fillRule="evenodd"></path>
                      <path id="sbisd-path-1" d="" stroke="none" fill="#fff" fillRule="evenodd"></path>
                      <path id="sbisd-path-2" d="" stroke="none" fill="#fff" fillRule="evenodd"></path>
                      <path id="sbisd-path-3" d="" stroke="none" fill="#fff" fillRule="evenodd"></path>
                  </svg>
              </div>
              <p className="grid-item-text">
      ...
      <div id="projects" className="section grid-items">
          <h2 className="grid-section-header">
              Projects
          </h2>
          <Link className="link-item" to="/ti">
            <div className="grid-item ti">              
                <h1 className="grid-item-header">
                    Coming soon...
                </h1>     
                <div className="grid-item-divider"></div>
      ...
      <div id="bio" className="section grid-items">
          <h2 className="grid-section-header">
              Me
          </h2>
          <div className="grid-item contact-info">
              <h1 className="grid-item-header no-left email-header">
                  hello@
                  <br></br>
                  juandgutierrez.com
              </h1>
              <div className="grid-item-divider no-left"></div>
              <p className="grid-item-text no-left">
              ...
              <div className="contact-links">
                  <a href="https://github.com/juandg16" className="contact-link">
                      <span className="contact-icon">
                          <svg className="case-item-icon icon-github" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 62 60">
                  ...
                  <a href="https://www.linkedin.com/in/juan-gutierrez/" className="contact-link">
                      <span className="contact-icon">
                          <svg className="case-item-icon icon-linkedin" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
          ...
          <div className="grid-item profile-pic">
              <div className="grid-item-bg" style={{backgroundImage: `url(${profile})`}}></div>
          </div>
      </div>
    </main>
  );
